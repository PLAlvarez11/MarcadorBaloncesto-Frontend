...
export const routes: Routes = [
  ...
  { path: 'jugadores', canActivate: [authGuard, accessGuard], loadComponent: () => import('./features/jugadores/jugadores-list/jugadores-list.component').then(m => m.JugadoresListComponent) },
